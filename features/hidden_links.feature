Feature: Hidden Links
	...
	Background:
		...
		Scenario: Delete project link is hidden for signed-in users
			Given I am signed in as "user@ticketee.com"
			When I follow "TextMate 2"
			Then I should not see the "Remove Project" link

		Scenario: Delete project link is shown to admins
			Given I am signed in as "admin@ticketee.com"
			When I follow "TextMate 2"
			Then I should see the "Remove Project" link
		...
		Scenario: Edit ticket link is hidden to a user without permission
			And I am signed in as "user@ticketee.com"
			When I follow "TextMate 2"
			And I follow "Shiny!"
