Feature: Assigning permissions
	...
	Background:
		...
		Scenario: View a project
			When I check a "View" for "TextMate 2"
			And I press "Update"
		...
		Scenario: Creating a ticket a project
			When I check a "View" for "TextMate 2"
			When I check a "Create tickets" for "TextMate 2"
			And I press "Update"
			And I follow "Sign out"
		...
		Scenario: Updating a ticket a project
			When I check a "View" for "TextMate 2"
			When I check a "Edit Tickets" for "TextMate 2"
			And I press "Update"
			And I follow "Sign out"
		...
		Scenario: Deleting a ticket a project
			When I check a "View" for "TextMate 2"
			When I check a "Delete Tickets" for "TextMate 2"
			And I press "Update"
			And I follow "Sign out"
		...
		Scenario: Changing states for a ticket
			When I check a "View" for "TextMate 2"
			And I check a "Change states" for "TextMate 2"
			And I press "Update"
			And I follow "Sign out"
